$(document).ready(function () {
	...
	function order_send() {
		...
		var data_order_values = $("#sortable").children("div.images-ids").map(function () {
	...
	$(document).on("click", '#build-book, #save_btn', function (e) {
		...
		var new_order = window.localStorage.getItem("new_order"); 
		new_order = JSON.parse(new_order)

		var finals = window.localStorage.getItem("final"); 
